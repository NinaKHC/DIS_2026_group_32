...
def show_you_lose() -> None:
    ...
    .yl-page{{width:100vw;height:100vh;display:flex;justify-content:center;align-items:center;background:#1a0a04;}}
    .yl-stage{{position:relative;width:min(100vw,calc(100vh*{aspect}));aspect-ratio:{aspect};}}
    .yl-bg{{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;z-index:1;pointer-events:none;user-select:none;}}
    {back_btn_css}
    </style></head>
    <body>
    <div class="yl-page">
